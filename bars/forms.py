...
from .models import Bar, Bar_Category, Bar_Facility, Bar_Amusement, PaymentMethod, Cast, Bar_room
...
class BarForm(forms.ModelForm):
    ...
    # fk_rooms = forms.ModelMultipleChoiceField(
    #     queryset = Bar_room.objects.all(),
    #     widget = FilteredSelectMultiple(
    #         verbose_name='room',
    #         is_stacked = False
    #     ),
...
class BarRoomForm(forms.ModelForm):
